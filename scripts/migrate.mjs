...
const {
  NEXT_PUBLIC_SANITY_PROJECT_ID="ncaeqkbu", // Sanity project ID
  NEXT_PUBLIC_SANITY_DATASET="production", // Sanity dataset (e.g., "production")
  NEXT_PUBLIC_SANITY_AUTH_TOKEN="skyTz698DVvUAcNBjowfJKXIaeJppNYfCeN8CCdh9QjYqGkxtcz7zQRVRfiJI9LhbYthLkWjwRG3arMNAi9PL7OzZZyyht3X5rUri9b44pQFpmMsuyeRM5VtlMTYevfyWwCeIr4IKcM1qiVNJso3KRmSJxf9aMN7KAxiMuWs8Ec9y5EYPq0F", // Sanity API token
